...
<body style="background-color: #f8f8f9; margin: 0; padding: 0; -webkit-text-size-adjust: none; text-size-adjust: none;">
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><a href="{{ $home }}"
																		style="outline:none; padding: 3rem" tabindex="-1"
																		target="_blank"><img alt="Emotours"
                                                                            src="{{ $message->embed(base_path() . '/public/static/image/mail/5f4fa970-2c78-4218-9e89-9953d812ddb4.png') }}"
																			style="display: block; height: auto; border: 0; width: 250px; height:4rem; max-width: 100%;"
																			title="Emotours" width="250" /></a></div>
															</td>
														</tr>
													</table>
												</td>
											...
											<tr>
												<td class="column column-1"
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><a
																		...
																		target="_blank"><img alt="Image of lock & key."
																			class="big"
                                                                            src="{{ $message->embed(base_path() . '/public/static/image/mail/___passwordreset.gif') }}"
																...
																<div style="font-family: Arial, sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span
																				style="font-size:30px;color:#2b303a;"><strong>Reset
													...
													<table border="0" cellpadding="0" cellspacing="0"
														...
														<tr>
															<td class="pad"
																style="padding-bottom:5px;padding-left:40px;padding-right:40px;padding-top:3px;">
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			style="margin: 0; font-size: 20px; text-align: center; mso-line-height-alt: 22.5px;">
																			<span
																				style="color:#fc6b31;font-size:23px;">
																				Hi, {{ $username }}	
																			</span></p>
																	</div>
																</div>
																	...
																	<div class=""
																		...
																		<p
																			...
																			<span
																				...
																				tempor incididunt ut labore et dolore.</span></p>
																	</div>
																</div>
															</td>
														</tr>
														...
														<tr>
															<td class="pad"
																...
																<div align="center" class="alignment">
																		<a
																		href="{{ $reset_link }}"
																		style="text-decoration:none;display:inline-block;color:#ffffff;background-color:#ff812d;border-radius:2px;width:16rem;border-top:0px solid transparent;font-weight:undefined;border-right:0px solid transparent;border-bottom:0px solid transparent;border-left:0px solid transparent;padding-top:12px;padding-bottom:12px;font-family:'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:15px;text-align:center;mso-border-alt:none;word-break:keep-all;"
																		target="_blank" class="reset-button"><span
																...
																<div align="center" class="alignment"
																	style="line-height:10px"><a href="www.example.com"
																		...
																		target="_blank"><img alt="Your logo. "
																			class="big"
                                                                            src="{{ $message->embed(base_path() . '/public/static/image/mail/aa73bcbb-1ce0-453a-8b6f-4f9e10336b9c.png') }}"
																			style="display: block; height: auto; border: 0; width: 10rem; heihgt:3rem; max-width: 100%; margin: 1.5rem auto 0"
																			title="Your logo. " width="10rem" height="3rem" /></a></div>
															</td>
														</tr>
													</table>
													<table border="0" cellpadding="0" cellspacing="0"
																		...
																		<tr>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Facebook"
																						height="32"
                                                                                        src="{{ $message->embed(base_path() . '/public/static/image/mail/facebook2x.png') }}"
																			...
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Twitter"
																						height="32"
                                                                                        src="{{ $message->embed(base_path() . '/public/static/image/mail/twitter2x.png') }}"
																						style="display: block; height: auto; border: 0;"
																						title="Twitter"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="Instagram"
																						height="32"
                                                                                        src="{{ $message->embed(base_path() . '/public/static/image/mail/instagram2x.png') }}"
																						style="display: block; height: auto; border: 0;"
																						title="Instagram"
																						width="32" /></a></td>
																			<td style="padding:0 10px 0 10px;"><a
																					...
																					target="_blank"><img alt="LinkedIn"
																						height="32"
                                                                                        src="{{ $message->embed(base_path() . '/public/static/image/mail/linkedin2x.png') }}"
																						style="display: block; height: auto; border: 0;"
																						title="LinkedIn"
																						width="32" /></a></td>
																		</tr>
																...
																<div style="font-family: sans-serif">
																	<div class=""
																		...
																		<p
																			...
																			<span
																				style="color:#95979c;font-size:12px;">Emotours
	...
	<style>
		.reset-button:hover{
			background-color: rgb(150, 48, 10);
		}
	</style>
</body>
</html>