...
<div class="col__TB11 nogutter__1VXx sidebar-checkout">
    <div class="rightHandRail__jF9L1">
        <div class="container__3NQR">
            <div class="container__qcyS">
                <div>
                    <div>
            ...
            <div class="bookWithConfidenceContainer__1QYT">
                <span class="title__1Wwg title__itNV title5__XmMG">Book with confidence</span>
                <div class="rowContainer__3GFH">
                    <svg width="41" height="32" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon__ci11">
                        <path
                        ...
                        <path
                            ...
                            fill="#fff" stroke="#2A2D32" stroke-width="1.5">
                        </path>
                    </svg>
                    <div class="rowRightHandContent__3HVk">
                        <span class="title__1Wwg title6__28O-">Great Trustpilot score</span>
                        <div class="childContainer__t60j">
                            <small>
                                With more than 110,000 traveler reviews, you can get the full picture before you go.
                            </small>
                        </div>
                    </div>
                </div>
                <div class="rowContainer__3GFH">
                    <svg width="41" height="28" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon__ci11">
                        <path
                            d="M37.528 3.523c7.33 7.508 1.178 8.818-5.401 15.242-6.579 6.423-11.171 10.177-18.422 
                            8.018-7.25-2.158-18.268-12.047-11.69-18.47 6.579-6.424 28.182-12.299 35.513-4.79z"
                            fill="#F6ECBB">
                        ...
                        <rect x="5.869" y="4.224" width="28" height="17" rx="1" fill="#fff"
                            stroke="#2A2D32" stroke-width="3.4" mask="url(#svg-53230343a)">
                        </rect>
                        <path
                            ...
                            fill="#2A2D32" stroke="#2A2D32" stroke-width=".7">
                        </path>
                        <path
                    ...
                    <div class="rowRightHandContent__3HVk">
                        <span class="title__1Wwg title6__28O-">Exceptional flexibility</span>
                        <div class="childContainer__t60j">
                            <small>
                                You&#x27;re in control
                ...
                <div class="rowContainer__3GFH">
                    <svg width="42" height="30" fill="none" xmlns="http://www.w3.org/2000/svg" class="icon__ci11">
                        <path
                    ...
                    <div class="rowRightHandContent__3HVk">
                        <span class="title__1Wwg title6__28O-">24/7 global support</span>
                        <div class="childContainer__t60j">
                            <small>
                                Our support team is here to help, 24/7.
                                <div class="helpOptions__2fIE contacts">
                                    <a class="callLink__2xHD phone-chat">
                                        <div class="helpOption__2lgT">
                                            <svg width="17" height="17" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                                class="icon__3A1i icon__ci11">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
                                    ...
                                    <a type="button" class="button__2dWp contact-chat">
                                        <div class="helpOption__2lgT">
                                            <svg width="17" height="17" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"
                                                class="icon__3A1i icon__ci11">
                                                <path fill-rule="evenodd" clip-rule="evenodd"
