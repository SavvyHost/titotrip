@extends('base')
@section("title", "Top Attraction | Pyramids")
@section("content")
    ...
    <header class="se_header relative">
        ...
        <div class="header-slider">
            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide image"><img src="static/image/header/3.png"></div>
    ...
    <main class="loc">
        ...
        <div class="main flex-column">
            ...
            <div class="title heading"> The Pyramdis in cairo city </div>
    ...
    <div class="destination full-width loc">
        ...
        <main>
            ...
            <div class="main flex-column">
                ...
                <div class="title full-width flex-start"> Top 15 tours in &nbsp; <span> " pyramids "</span> </div>
                    ...
                    <div class="home-slider full-width flex">
                        ...
                        <div class="swiper-wrapper full-width flex-wrap">
                            ...
                            @foreach( $attractions as $tour )
                                ...
                                <a href="/tour?id={{$tour->id}}" data-id="{{$tour->id}}" class="flex-column loc-card relative swiper-slide active tour-card">
            ...
            <div class="buttons full-width flex">
                <button class="more">See more tours</button>
            </div>
    ...
    <div class="full-width flex-column scroll-bar">
        ...
        <main class="flex-space">
            ...
            <ul class="pages flex">
                ...
                <a class="no-hover">Attractions</a>
